...
types <- c("PME_apoptosis", "PME_inflammatory_response", "PME_interferon_alpha_response", "PME_interferon_gamma_response", "PME_oxidative_phosphorylation", "PME_tnfa_signaling_via_nfkb")
types_permute <- c("PME_apoptosis_permute", "PME_inflammatory_response_permute", "PME_interferon_alpha_response_permute", "PME_interferon_gamma_response_permute", "PME_oxidative_phosphorylation_permute", "PME_tnfa_signaling_via_nfkb_permute")
