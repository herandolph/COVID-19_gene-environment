...
## calculate avg BMI across samples if missing 
...
for (i in 1:length(celltypes)){
	...
	## model severity differential expression
	design = model.matrix(~ Dataset + Sex + Age_scale + BMI_scale + counts + RespSupp_Sampling, data = md_i)
